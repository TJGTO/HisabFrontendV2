...
function AchievementSection({ open, onClose }: achivementDialogProps) {
  const handleClose = () => {
    onClose();
  };
  return (
            ...
            <section>
              <div className="container px-5 py-14 mx-auto">
                <div className="grid grid-cols-2 gap-4">
                  <div className="text-gray-600 dark:text-gray-400" key="1">
                  ...
                  <div className="text-gray-600 dark:text-gray-400" key="2">
                    <div className="border-2 border-gray-600 px-4 py-6 rounded-lg transform transition duration-500 hover:scale-110 bg-stone-100 dark:bg-gray-800">
                      <div className="flex justify-center h-20 w-full">
                        <svg
                          className="w-[35px] h-[35px] md:w-[50px] md:h-[50px]"
                      ...
                      <div className="flex justify-center w-full">
                        <p className="leading-relaxed ">
                          {" "}
                          {"Player of the tournamanet"}
                        </p>
                      </div>
                    </div>
                  </div>
                  <div className="text-gray-600 dark:text-gray-400" key="3">
                    <div className="border-2 border-gray-600 px-4 py-6 rounded-lg transform transition duration-500 hover:scale-110 bg-stone-100 dark:bg-gray-800">
                      <div className="flex justify-center h-20 w-full">
                        <svg
                          className="w-[35px] h-[35px] md:w-[50px] md:h-[50px]"
                  ...
                  <div className="text-gray-600 dark:text-gray-400" key="4">
                    <div className="border-2 border-gray-600 px-4 py-6 rounded-lg transform transition duration-500 hover:scale-110 bg-stone-100 dark:bg-gray-800">
                      <div className="flex justify-center h-20 w-full">
                        <svg
                          className="w-[35px] h-[35px] md:w-[50px] md:h-[50px]"
